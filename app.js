/**
 * Created by joniweiss on 8/27/15.
 */
/*
...
var current="QueerCon is Today!";    //-->enter what you want the script to display when the target date and time are reached, limit to 20 characters
var year=2015;    //-->Enter the count down target date YEAR
var month=109;      //-->Enter the count down target date MONTH
